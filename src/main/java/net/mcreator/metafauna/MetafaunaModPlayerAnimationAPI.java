package net.mcreator.metafauna;
...
import net.mcreator.metafauna.network.LoadPlayerAnimationMessage;
...
public class MetafaunaModPlayerAnimationAPI {
	...
	private static class AnimationLoader {
		...
		public static void loadAnimations(PlayerEvent.PlayerLoggedInEvent event) {
			if (MetafaunaModPlayerAnimationAPI.initialized.get(event.getEntity().getUUID()) == null) {
				if (event.getEntity() instanceof ServerPlayer player) {
					...
					MetafaunaModPlayerAnimationAPI.initialized.put(player.getUUID(), true);
				}
			}
		}
