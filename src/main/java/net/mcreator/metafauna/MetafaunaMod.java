...
@Mod("metafauna")
public class MetafaunaMod {
	public static final Logger LOGGER = LogManager.getLogger(MetafaunaMod.class);
	public static final String MODID = "metafauna";

	public MetafaunaMod(IEventBus modEventBus) {
